...
<form id="updateFormlhl" enctype="multipart/form-data">
    ...
    <table class="input tabContent">
        <tr>
            ...
            <td>
                <select id="protype" name="protype">
                    <option value="1" ${product.protype==1 ? 'selected' : ""}>
                        衬衣
                    </option>
                    <option value="2" ${product.protype==2 ? 'selected' : ""}>
                        &nbsp;&nbsp;
                        裤子
                    </option>
                    <option value="3" ${product.protype==3 ? 'selected' : ""}>
                        &nbsp;&nbsp;
                        连衣裙
                    </option>
                    <option value="4" ${product.protype==4 ? 'selected' : ""}>
                        &nbsp;&nbsp;
                        "塑身衣
                    </option>
                    <option value="5" ${product.protype==5 ? 'selected' : ""}>
                        &nbsp;&nbsp;
                        睡衣
                    </option>
                    <option value="6" ${product.protype==6 ? 'selected' : ""}>
                        &nbsp;&nbsp;
                        小西装
                    </option>
                    <option value="7" ${product.protype==7 ? 'selected' : ""}>
                        &nbsp;&nbsp;
                        T恤
                    </option>
                </select>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="name"  value="${product.name}" class="text" maxlength="200" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="xiaoshoujia" value="${product.xiaoshoujia}"  class="text" maxlength="16" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="chengbenjia" value="${product.chengbenjia}" class="text" maxlength="16" title="前台不会显示，仅供后台使用" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
					<span class="fieldSet">
						<input type="hidden" name="images"  value="${product.images}"  id="asdd" class="text" maxlength="200" title="应用于首页、宣传页，留空则由系统自动生成" />
        ...
        <tr>
            ...
            <td>
                <input type="text" name="unit"  value="${product.unit}"  class="text" maxlength="200" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="kecun" value="${product.kecun}"   class="text" maxlength="9" title="留空表示不计库存" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="stockMemo"  value="${product.stockMemo}"   class="text" maxlength="200" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="createtime"  value="${product.createtime}"   class="text" maxlength="200" />
            </td>
        </tr>
        <tr>
            <th>
    ...
    <table class="input">
        <tr>
            ...
            <td>
                <input type="button" class="button" onclick="xiugailhl()" value="确&nbsp;&nbsp;定" />
...
<script type="text/javascript">
    ...
    function xiugailhl(){
        $.ajax({
            url:"<%=request.getContextPath()%>/productcontroller/updateproduct.lhtml",
            data:$("#updateFormlhl").serialize(),
            type:"post",
            dataType:"json",
